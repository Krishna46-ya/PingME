    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6">
            <div className="max-w-xl text-center">
                <h1 className="text-3xl font-bold mb-4">About PingMe (Chat GPT)</h1>
                <p className="text-gray-700 mb-4">
                    PingMe is a simple and modern chat app designed to help you stay connected
                    with your friends and family in real-time.
                </p>
                <p className="text-gray-700 mb-4">
                    Whether you're chatting one-on-one or one-on-one (We dont support group chat), PingMe makes conversations
                    fast, secure, and fun.
                </p>
